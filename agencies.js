...
(function () {
  ...
  //
  // Rendered for everyone, INCLUDING while the soft-launch toggle is off. The
  // gate belongs on the page, not on the link: wire.html shows a coming-soon
  // panel with the contributor sign-up when the feed is not visible to you,
  // and hiding the nav as well left no way to reach it.
