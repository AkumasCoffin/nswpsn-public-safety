...
--
-- The operator picks a rough location on a map with a 1km circle; the browser
...
-- the server. So lat/lon here is deliberately imprecise (good to ~1km) and must
-- NOT be treated as an exact position.
