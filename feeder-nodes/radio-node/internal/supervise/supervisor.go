// Package supervise launches and monitors external child processes (SDR-Trunk
// and a local rdio-scanner) as opaque children: launch with the configured
// command line, capture logs, restart on crash, with a crash-loop guard.
package supervise
