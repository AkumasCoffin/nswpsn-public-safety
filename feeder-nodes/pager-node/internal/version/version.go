...
//
//	go build -ldflags "-X github.com/AkumasCoffin/nswpsn-node/pager-node/internal/version.Version=1.2.3"
var Version = "0.0.0-dev"

// String returns a human-readable version line including OS/arch and Go version.
func String() string {
	return fmt.Sprintf("pager-node %s (%s/%s, %s)", Version, runtime.GOOS, runtime.GOARCH, runtime.Version())
}
